...
{	//CityStore is a copy of UrbanMall mission, it uses another secondary mission building
	...
	{	//When player enters mission target zone at primary mission
		...
		m_MissionMessage1 = "Хорошая работа, салага. Хватай провиант и вали оттуда. "+ SurvivorName +" никогда не говорила мне о своем местонахождении, потому что хочет быть в полной безопасности от бандитов.";
