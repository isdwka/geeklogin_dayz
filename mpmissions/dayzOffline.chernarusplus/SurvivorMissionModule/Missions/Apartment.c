class ApartmentMission extends SurvivorMissions
{
	...
	void ApartmentMission()
	{
		...
		//Mission messages 
        m_MissionMessage1 = SurvivorName +" Был моим лучшим студентом. Я пытался связаться с ним, однако безуспешно.";
        m_MissionMessage2 = "Он рассказал мне, что спрятал морской сундук с экипировкой, где-то в квартире. Несколько дней назад он забаррикодировал входную дверь подъезда от инфицированных.";
        m_MissionMessage3 = "Он как раз жил в одной из таких квартир в\n** "+ m_MissionLocation +" на "+ m_MissionLocationDir +" **\nПроверь, возможно "+SurvivorName+" ещё жив. Если нет, то забери его манатки и свали оттуда.";
