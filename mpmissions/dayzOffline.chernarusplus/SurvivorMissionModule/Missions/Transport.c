class TransportMission extends SurvivorMissions
{
	...
	{		
		...
		TStringArray SurvivorNames = {"Юрий","Михаил","Борис","Валерий","Анатолий","Иван","Алексей","Дмитрий","Сергей","Николай","Владимир"};
		SurvivorName = SurvivorNames.GetRandomElement();
		
		//Set mission messages for primary mission
		m_MissionMessage1 = SurvivorName +", оказался крысой и обокрал меня. Он стащил весь запас конап.. эмм.. - лечебного каннабиса, что мы используем в самых жёстких случаях, когда без наркоза никак.";
		m_MissionMessage2 = "Но мои ребята выследили его убежище. Однако он их заметил и сейчас пытается уйти от погони. \nТак как ты ещё зелёный салага, поручаю самоё простое: вернуть украденное.";
		m_MissionMessage3 = SurvivorName +" спрятал трав.. эмм - лечебный каннабис в гаражах в "+ m_MissionLocation +". \nНайди их. Думаю он не дурак и догадался закрыть ворота, поэтому захвати с собой отмычку или что-нибудь потяжелее.";
	...
	{	//When player enters mission target zone at primary mission
		...
		m_MissionMessage1 = "Хорошо салага, я думал тебе понадобиться больше времени. "+ SurvivorName +" не успел заправить машину. Иначе бы скрылся на ней. Укомплектуй и заправь автомобиль. У нас объявился.. эмм.. срочный пациент. Положи все экземпляры каннабиса в сумку, что на столе.";
		m_MissionMessage2 = "Направляйся на "+ m_MissionDescription[3] +"-заправку \nтам оставь сумку с травой на столе возле кассы. "+ SurvivorName +" поплатится за воровство своим самым важным органом тела. \nТы же не о члене подумал? - Я говорил о мозгах. Надеюсь ты понимаешь, что у меня красть не нужно.";
		m_MissionMessage3 = "Поторопись салага. Пациент ждёт своей дозы в "+ m_MissionDescription[3] +". Не нужно объяснять, что "+ SurvivorName +" действовал не один и тебя могут ждать.";
