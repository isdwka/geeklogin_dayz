class CityMallMission extends SurvivorMissions
{
	...
	{		
		...
		TStringArray SurvivorNames = {"Тамарова", "Лежскова", "Бласонова", "Харитонова", "Горбачёва", "Соколова", "Березина", "Хомякова", "Традемчук", "Ярославовна"};
		SurvivorName = SurvivorNames.GetRandomElement();
		
		//Set mission messages for primary mission
		m_MissionMessage1 = "Наша учительница "+ SurvivorName +", рассказала мне, что спасла некоторых детей из заражённых семей. Я пообещал ей, что помогу найти провизию, для её детишек. Иначе бы не дала... Что?";
		m_MissionMessage2 = "Вчера я нашёл забаррикадированный магазин в\n** "+ m_MissionLocation +" **\n. Возможно, там есть ещё немного еды. Вокруг полно зомби и я не рискнул туда заглянуть.";
		m_MissionMessage3 = "Ей срочно нужно следующие продукты:\n- "+ ReqFoodAmount +" консервированных банок и..\n- "+ ReqMedAmount +" пакетов антибиотиков \n"+ SurvivorName +" и дети нуждаются в твоей помощи! А то она расскажет моей жене.";
	...
	{	//When player enters mission target zone at primary mission
		...
		m_MissionMessage1 = "Хорошая работа, салага. Хватай провиант и вали оттуда. "+ SurvivorName +" никогда не говорила мне о своем местонахождении, потому что хочет быть в полной безопасности от бандитов и мусорщиков.";
		m_MissionMessage2 = "Думаю, лучше всего будет, если ты оставишь припасы в тихой комнате \n** "+ m_MissionDescription[3] +" ** полицейского участка. Положи всё в оранжевый рюкзак. Я проверю и попробую связаться с ней по рации.";
		m_MissionMessage3 = "Я оставил тебе кое-что, салага. Надеюсь ты понимаешь, что нас могли прослушивать и устроить тебе засаду в "+ m_MissionDescription[3] +". Удачи!";
