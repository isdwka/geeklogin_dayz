...
{	//UrbanMall is a copy of CityMall mission, it has equal functionality but uses different MissionBuilding 
	...
	{		
		...
		TStringArray SurvivorNames = {"Тамарова", "Лежский", "Бласонова", "Харитонова", "Горбачёва", "Соколова", "Березин", "Хомяк", "Традемчук", "Ярославовна"};
	...
	{	//When player enters mission target zone at primary mission
		...
		m_MissionMessage2 = "Думаю, лучше всего будет, если ты оставишь припасы в тихой комнате \n** "+ m_MissionSecondaryLoc +" ** полицейского участка. Положи всё в оранжевый рюкзак. Я проверю и попробую связаться с ней по рации.";
		m_MissionMessage3 = "Я оставил тебе кое-что, салага. Надеюсь ты понимаешь, что нас могли прослушивать и устроить тебе засаду в "+ m_MissionSecondaryLoc +". Удачи!";
